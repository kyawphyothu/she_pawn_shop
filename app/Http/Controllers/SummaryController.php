...
class SummaryController extends Controller
{
    ...
    public function dailyCreate()
    {
        ...
        if (request()->action == 'CreateDailySummary') {
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////အိမ်အတွက်
            ...
            $dailySummary->updated_at = $date;
            $dailySummary->save();
        } elseif (request()->action == 'DeleteDailySummary') {
            //delete daily summary
            $dailySummaryDelete = Summary::where('created_at', $date)->where('dmyearly', 0)->delete();
        }
    ...
    public function monthlyCreate()
    {
        ...
        if (request()->action == 'CreateMonthlySummary') {
            /////////////////////////////////////////////////////////////////////////////////////////////////အိမ်အတွက်
            ...
            $monthlySummary->updated_at = $endDate;
            $monthlySummary->save();
        } elseif (request()->action == 'DeleteMonthlySummary') {
            //delete monthly summary
            $monthlySummaryDelete = Summary::where('created_at', $endDate)
                ->where('dmyearly', 1)
                ->delete();
        }
        //redirect
    ...
    public function yearlyCreate()
    {
        ...
        //yearly create
        if (request()->action == 'CreateYearlySummary') {
            ...
            $yearlySummary->updated_at = $endDate;
            $yearlySummary->save();
        } elseif (request()->action == 'DeleteYearlySummary') {
            $yearlySummaryDelete = Summary::where('created_at', $endDate)->where('dmyearly', 2)->delete();
        }
